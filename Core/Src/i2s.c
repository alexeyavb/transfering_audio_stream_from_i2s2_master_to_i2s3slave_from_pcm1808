...
void HAL_I2S_MspInit(I2S_HandleTypeDef* i2sHandle)
{
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = I2S2_DATA_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(I2S2_DATA_IN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END SPI3_MspInit 0 */
    ...
    PB5     ------> I2S3_SD
    */
    GPIO_InitStruct.Pin = PCM0_SYNC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
    HAL_GPIO_Init(PCM0_SYNC_GPIO_Port, &GPIO_InitStruct);
    ...
    GPIO_InitStruct.Pin = PCM0_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF7_I2S3ext;
    HAL_GPIO_Init(PCM0_OUT_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = PCM0_INP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
    HAL_GPIO_Init(PCM0_INP_GPIO_Port, &GPIO_InitStruct);
    ...
    __HAL_LINKDMA(i2sHandle,hdmatx,hdma_i2s3_ext_tx);
...
void HAL_I2S_MspDeInit(I2S_HandleTypeDef* i2sHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> I2S1_SD
    */
    HAL_GPIO_DeInit(GPIOA, I2S1_LRCK_Pin|I2S1_BCK_Pin|I2S1_DATA_OUT_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> I2S2_SD
    */
    HAL_GPIO_DeInit(I2S2_SCK_GPIO_Port, I2S2_SCK_Pin);

    HAL_GPIO_DeInit(GPIOB, I2S2_LRCK_Pin|I2S2_BCK_Pin|I2S2_DATA_IN_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PB5     ------> I2S3_SD
    */
    HAL_GPIO_DeInit(PCM0_SYNC_GPIO_Port, PCM0_SYNC_Pin);

    HAL_GPIO_DeInit(GPIOB, PCM0_CLK_Pin|PCM0_OUT_Pin|PCM0_INP_Pin);
